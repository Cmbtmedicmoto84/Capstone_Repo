    ...
    public class ApplicationDbContext : IdentityDbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Product>()
                .HasData(
                    new Product { ProductId = 12, ProductName = "Ultra-Fast Internet", ProductPrice = 59.99, ProductDescription = "Our fastest Internet with syncronous Up/Down speeds of 1 Gig!!" },
